...
<ul>
<li>Raw data: The datasets used in this analysis are collected by DataHub and sourced from the World Bank. The World Bank compiles data collected from various international sources, including, but not limited to, the World Bank national accounts data and OECD National Accounts data files.</li>
<li> Data Links: [GDP per Country](https://datahub.io/core/gdp) / [Population per Country](https://datahub.io/core/population)
...
<ul>
<li><b>Linearity</b>: The relationship between the independent variable (average GDP per capita) and the dependent variable (average population growth) should be linear. The curve in the red LOESS line suggests the relationship is <b> not linear</b>. The non-linearity suggests that population growth may respond differently to GDP changes at different economic development stages. </li>
<li><b>Normality of Residuals</b>: The residuals should be normally distributed. Since the fitted values are heavily compressed around one end (1.4), the normality assumption is <b>violated</b>. This suggests that the specificity of our predictions is off, particularly for countries at economic extremes.</li>
<li><b>Homoscedasticity (constant variance)</b>: The residuals should have a consistent spread across all fitted values. However, the spread of residuals as fitted values is increasing (funnel-shape) which indicates heteroscedasticity, meaning the variance is not constant and this assumption is <b>violated</b>. This suggests that population growth becomes more variable and less predictable at higher growth rates, possibly reflecting greater economic instability in rapidly growing populations.</li>
</ul>
...
<ul>
<li><b>Nonlinear Modeling</b>: If the effect of GDP on population growth changes at different income levels, nonlinear models may better capture the relationship. This question would personalize the relationship between the two variables to different stages of a country's evolution in the global economic system, showing differences between countries similar to each other. </li>
<li><b>Regional Analysis</b>: Future analysis could involve analyzing regional trends, separating countries into different income groups to see if different patterns emerge. Regional economies tend to feature similar economic makeup so by focusing a question on specific regions it could allow for an understanding if the relationship is more prevalent in some parts of the world rather than others.</li>
<li><b>Consider Alternative Economic Measures</b>: Future analysis could use GDP adjusted for PPP. This adjustment could help reduce distortions caused by currency exchange rates and provide a more fair comparison of how much people in each country can actually afford. This type of question would standardize the comparisons and possibly provide more clarity as to the specific differences between different countries.</li>
<li><b>Include more variables</b>: A multiple regression model that includes other variables - such as education levels and healthcare access - might provide a clearer picture of what drives population growth. These variables tend to be indicators of quality of life the higher they are for a respective country, so relationships could be identified between countries that have a high quality of life and how their population growth and economic growth change from that</li>
</ul>
